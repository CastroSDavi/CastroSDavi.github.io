...
export default class QuizUI {
    ...
    _cacheDOMelements() {
        this.elements = {
            ...
            predefinedQuizzesSection: document.getElementById('hub-predefined-quizzes-section'),
            predefinedQuizzesContainer: document.getElementById('hub-predefined-quizzes-container'),
            predefinedQuizzesLoading: document.getElementById('hub-predefined-quizzes-loading'),
            predefinedQuizzesEmpty: document.getElementById('hub-predefined-quizzes-empty'),
            predefinedQuizzesError: document.getElementById('hub-predefined-quizzes-error'),
            predefinedQuizzesMetrics: document.getElementById('hub-predefined-quizzes-metrics'),
            predefinedQuizzesCount: document.getElementById('hub-predefined-quizzes-count'),
            predefinedQuestionsTotal: document.getElementById('hub-predefined-questions-total'),
