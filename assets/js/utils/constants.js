...
export const API_URLS = {
    ...
    question_detail: (perguntaId) => `/api/question/${perguntaId}/`,
    toggle_favorite_status: (perguntaId) => `/api/question/${perguntaId}/toggle_favorite/`,
    report_question_issue: (perguntaId) => `/api/question/${perguntaId}/report/`,
    submit_support_request: '/api/support/requests/',
