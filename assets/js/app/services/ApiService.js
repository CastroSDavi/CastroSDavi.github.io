...
export default class ApiService {
    ...
    async claimLevelReward(levelId, rewardId) {
        if (!API_URLS.claim_level_reward) {
            console.error('ApiService.js: URL para claim_level_reward não definida em API_URLS.');
        ...
        return _request(API_URLS.claim_level_reward, 'POST', payload);
    }
}