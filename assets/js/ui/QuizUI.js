...
export default class QuizUI {
    ...
    _cacheDOMelements() {
        this.elements = {
            ...
            hubTotalQuestionsCountMetric: document.getElementById('hub-total-questions-count-metric'),
            hubQuickQuizCount: document.getElementById('hub-quick-quiz-count'),
            hubQuickQuizCountCard: document.getElementById('hub-quick-quiz-count-card'),
            ...
            hubSimulatedQuizBtn: document.getElementById('hub-simulated-quiz-btn'),
            hubSmartReviewBtn: document.getElementById('hub-smart-review-btn'),
            hubTimeAttackBtn: document.getElementById('hub-time-attack-btn'),
