...
export default class QuizUI {
    ...
    _cacheDOMelements() {
        this.elements = {
            ...
            hubMarathonModeBtn: document.getElementById('hub-marathon-mode-btn'),
            hubSmartReviewBtn: document.getElementById('hub-smart-review-btn'),
            hubSprintModeBtn: document.getElementById('hub-sprint-mode-btn'),
            hubFocusModeBtn: document.getElementById('hub-focus-mode-btn'),
